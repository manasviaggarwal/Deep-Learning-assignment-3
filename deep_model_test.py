...
def load_data():
  ...
  # raw_dataset2 = list(test_examples("snli_1.0/snli_1.0_dev.jsonl"))
...
def model_test(test):
  json_file = open('model/deep_model_json.json', 'r') 
  loaded_model_json = json_file.read()
  json_file.close()
  loaded_model = model_from_json(loaded_model_json)
# load weights into new model
  loaded_model.load_weights("model/deep_model_weights.h5")
