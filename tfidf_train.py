...
raw_dataset2 = list(val_examples("snli_1.0/snli_1.0_dev.jsonl"))
...
print("Model acc is on train set is: ",model.score(features_X, yy)*100 )
prediction=model.predict(f_t)
print("Model acc is on Validation set is: ",model.score(f_t1, yy2)*100 )
prediction=model.predict(f_t)
...
#         continue
#     elif:
#         y_final.append(yy2[i])
#         if prediction[i]==yy2[i]:
#             correct+=1


# tot=len(y_final)

# print("Model acc is on val set is: ",correct/tot*100 )
